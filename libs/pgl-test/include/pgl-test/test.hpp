...
namespace pgl::test {
        ...
        auto generate_random_args([[maybe_unused]]type function(Args...))
        ...
        bool function_property(ret_type (*function)(Args...),
        ...
        template<typename Class, typename... ClassArgs,
                 typename type, typename... MemberArgs,
                 typename Property>
        bool function_property(Class (*maker)(ClassArgs...),
