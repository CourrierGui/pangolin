...
namespace pgl {
    ...
    struct algebraic_vector : public base_vector<type, dim,vector_type> {
        template<typename t>
            using container_of = algebraic_vector<t, dim,vector_type>;
        ...
        inline constexpr algebraic_vector(std::convertible_to<type> auto ... args)
            noexcept;
        ...
        inline constexpr auto operator*=(std::convertible_to<type> auto scalar)
            noexcept -> algebraic_vector<type,dim,vector_type>&;
