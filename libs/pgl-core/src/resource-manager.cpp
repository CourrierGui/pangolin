...
namespace pgl {
    ...
    shader ResourceManager::load_shader_from_file(const std::string& v_shader_file,
                                                  const std::string& f_shader_file,
                                                  const std::string& g_shader_file)
    {
    ...
    Texture2D ResourceManager::load_texture_from_file(const std::string& file, bool alpha)
    {
