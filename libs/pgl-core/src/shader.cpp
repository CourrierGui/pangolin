...
namespace pgl {
	...
	void Shader::setVector2f(const char* name, const pgl::float2& value) {
	...
	void Shader::setVector3f(const char* name, const pgl::float3& value) {
	...
	void Shader::setVector4f(const char* name, const pgl::float4& value) {
